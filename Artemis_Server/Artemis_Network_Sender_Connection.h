...
namespace Artemis
{
class Artemis_Network_Sender_Connection :
    public boost::enable_shared_from_this<Artemis_Network_Sender_Connection>,
...
typedef boost::shared_ptr<Artemis_Network_Sender_Connection>
Artemis_Network_Sender_Connection_ptr;
}
